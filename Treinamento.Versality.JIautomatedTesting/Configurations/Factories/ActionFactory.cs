...
namespace Treinamento.Versatile.UIAutomatedTesting.Configurations.Factories
{
    public class ActionFactory : DriverFactory
    {
        ...
        ///<summary>
        ///Method to insert a text in an element
        ///</summary>
        ...
        ///<summary>
        ///Method for selecting on an element by index
        ///</summary>
        ...
        ///<summary>
        ///Method thtat returns the text of the element by index
        ///</summary>
        public string ReturnTextByIndex(By by, int index, int timeout = 10) => FindElements(by, timeout)[index].Text;

        ///<summary>
        ///Method thtat returns the text of the element by attribute
        ///</summary>
        ...
        ///<summary>
        ///Method that checks if element's text constains the expected text
        ///</summary>
        ...
        ///<summary>
        ///Method that changes the browser tab
        ///</summary>
        ...
        ///<summary>
        ///Method to zoom by percentege
        ///</summary>
        public void ZoomPercentage(int percent) => ((IJavaScriptExecutor)Driver()).ExecuteScript("document.body.style.zoom = ' " + percent + "%';");

        ///<summary>
        ///Method that induces mouse houver 
        ///</summary>
        public void MouseHouver(IWebElement element) => new Actions(Driver()).MoveToElement(element).Perform();

        ///<summary>
        ///Method to scrool to the element
        ///</summary> 
        public void ScrollToElement(IWebElement element, int up = 0, int down = 0) => ((IJavaScriptExecutor)Driver()).ExecuteScript("argument[0].scrollIntoView(true);window.scrollBy(" + up + "," + down + ")", element);

        ///<summary>
        ///Method to accept to alert
        ///</summary>
